...
for (let i = 0; i<miCamino.material.length; i++){
  if(i == 0){
    console.log(`lo primero que debo llevar es ${miCamino.material[i].nombre} y es ${miCamino.material[i].descripcion}`)
  }else if(i == 1){
    console.log(`lo segundo que debo llevar es ${miCamino.material[i].nombre} y es ${miCamino.material[i].descripcion}`)
  }else if(i == 2){
    console.log(`lo tercero que debo llevar es ${miCamino.material[i].nombre} y es ${miCamino.material[i].descripcion}`)
  }else{
    console.log(`y por ultimo debo llevar la ${miCamino.material[i].nombre} que es ${miCamino.material[i].descripcion}`)
  }
}
...
for (let i = 0; i<miCamino.cimas.length; i++){
  console.log(`Para subir al ${miCamino.cimas[i].nombre} debo subir ${miCamino.cimas[i].altitud} y debo viajar a ${miCamino.cimas[i].localizacion}`)
}
...
for (i = 0; i<miCamino.subiendoAlEverest[0][0].campoBase[0].campoI.campoII.campoIII.campoIV.length; i++){
  if(typeof miCamino.subiendoAlEverest[0][0].campoBase[0].campoI.campoII.campoIII.campoIV[i] == "string"){
   miarray += miCamino.subiendoAlEverest[0][0].campoBase[0].campoI.campoII.campoIII.campoIV[i]
   miarray += " "
  }
}
...
// console.log(`${miCamino.subiendoAlEverest[0][0].campoBase[0].campoI.campoII.campoIII.campoIV[0]},${miCamino.subiendoAlEverest[0][0].campoBase[0].campoI.campoII.campoIII.campoIV[1]} ${miCamino.subiendoAlEverest[0][0].campoBase[0].campoI.campoII.campoIII.campoIV[2]} ${miCamino.subiendoAlEverest[0][0].campoBase[0].campoI.campoII.campoIII.campoIV[3]} ${miCamino.subiendoAlEverest[0][0].campoBase[0].campoI.campoII.campoIII.campoIV[4]} ${miCamino.subiendoAlEverest[0][0].campoBase[0].campoI.campoII.campoIII.campoIV[6]}${miCamino.subiendoAlEverest[0][0].campoBase[0].campoI.campoII.campoIII.campoIV[7]}`) ----------- Esto es algo feo
...
for (let i = 0; i<miCamino.material.length; i++){  
    console.log(`${miCamino.material[i].imagenes[0].imagen1.url} ${miCamino.material[i].imagenes[1].imagen2.url}`)
}

let altitudmedia = 0;

for (let i = 0; i<miCamino.cimas.length; i++){
  altitudmedia = altitudmedia + miCamino.cimas[i].altitud;
  if (i == miCamino.cimas.length-1){ 
    i++   
    altitudmedia = altitudmedia/i;
    altitudmedia = altitudmedia.toFixed(3)
    console.log(`La altitud media de las montañas es ${altitudmedia}`);
  }  
}
